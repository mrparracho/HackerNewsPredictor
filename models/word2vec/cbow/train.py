...
def train():
    ...
    # Prepare data
    # Example sentence: "python machine learning is fun"
    # For window_size=2, when predicting "learning":
    # - Context before: ["python", "machine"]
    # - Context after: ["is", "fun"]
    # - Target: "learning"
    vocab = [
    ...
    for epoch in range(config['NUM_EPOCHS']):
        ...
        if avg_loss < best_loss:
            ...
            with open(os.path.join(checkpoint_dir, 'cbow_input_embeddings.txt'), "w") as f:
